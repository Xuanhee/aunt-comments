...
const theme = getLocalStorage('vue-admin-pro-theme')
const { collapse } = getLocalStorage('vue-admin-pro-collapse')
const { language } = getLocalStorage('vue-admin-pro-language')
